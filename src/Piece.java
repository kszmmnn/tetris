...
public class Piece {
	...
	Piece() {
		...
		switch (0) {
		case 0: // square
			blocks[0] = new Block(color, 8, 0);
			blocks[1] = new Block(color, 9, 0);
			blocks[2] = new Block(color, 8, 1);
			blocks[3] = new Block(color, 9, 1);
			break;
		...
		case 3: // line
			blocks[0] = new Block(color, 7, 0);
			blocks[1] = new Block(color, 8, 0);
			blocks[2] = new Block(color, 9, 0);
			blocks[3] = new Block(color, 10, 0);
			break;

		case 4: // 3-ending
			blocks[0] = new Block(color, 8, 0);
			blocks[1] = new Block(color, 8, 1);
			blocks[2] = new Block(color, 9, 1);
			blocks[3] = new Block(color, 8, 2);
			break;
		default:
